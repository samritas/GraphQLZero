  ...
  return (
    <div className="mb-5">
      <div>
        ...
        <h1 className="font-title mt-2 text-[36px] font-bold leading-tight tracking-tight text-[#2A3439]">
          Image Library
        </h1>
        <div className="mt-1 flex flex-wrap items-center justify-between gap-x-6 gap-y-3">
          <p className="max-w-2xl text-[16px] leading-relaxed text-[#64748b]">
            Manage your application&apos;s visual assets across all albums. Filter by ID or album
